...
// widgets/image_toggle_button.py
public class ImageToggleButton : ToggleButton
{
    ...
    public ImageToggleButton(Widget? parent, int x, int y, Image img, int u, int v, bool isChecked,
        bool isVisible = true, bool isEnabled = true)
        : base(parent, x, y, 7, 7, isChecked, isVisible, isEnabled)
    {
        _img = img;
        _u = u;
        _v = v;
