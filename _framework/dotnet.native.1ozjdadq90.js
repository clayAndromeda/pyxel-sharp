...
var ASM_CONSTS = {
 ...
 6422076: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 6422159: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 6422228: () => { return window.innerWidth; },  
 6422258: () => { return window.innerHeight; }
};
